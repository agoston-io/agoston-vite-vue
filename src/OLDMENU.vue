  ...
  <header class="bg-white">
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center">
          ...
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AmazingApp</span>
        </a>
    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        ...
        <router-link class="-m-1.5 p-1.5" :to="{ name: 'AppLandingPage' }">
          <span class="sr-only">Amazing App</span>
          <span>Amazing App</span>
        </router-link>

      </div>
      <div class="lg:flex lg:gap-x-12">
        <router-link class="text-sm font-semibold leading-6 text-gray-900"
          :to="{ name: 'AppLogin' }">Profile</router-link>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Data (GraphQL examples)</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">List data (GraphQL Query)</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Change data (GraphQL Mutation)</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Real-time (GraphQL Subscription)</a>
      </div>
      <div class="lg:flex lg:flex-1 lg:justify-end">
        ...
        <div v-else>
          <router-link class="text-sm font-semibold leading-6 text-gray-900" :to="{ name: 'AppLogin' }"><span
              class="fw-bold me-1">{{ $session.auth_subject }}</span></router-link>
